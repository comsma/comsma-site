    ...
    return (
        <div className={"mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 mt-20 gap-10"}>
            <div className={"col-span-1 flex flex-col justify-around p-5"}>
                ...
                <div className={"flex flex-row justify-between text-secondary pt-10"}>
            ...
            <div className={"col-span-1 p-5 md:col-start-2"}>
                <div className={"max-w-lg rounded-2xl overflow-clip shadow-2xl"}>
                    <img className={"h-auto w-auto"} src={"/images/collin-portrait.jpg"} alt={"A photo of Collin"} />
                </div>
